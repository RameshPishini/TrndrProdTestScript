...
public class OtherCategoryL4Screen {
	...
	public static WebElement level4(WebDriver driver) {
		...
		//WebElement l3popupbtn1=wait.until(ExpectedConditions.);
		 ...
		 act.clickAndHold(L4card1src1).build().perform();		
			...
			//WebElement ansquestbtn1 = wait.until(ExpectedConditions.elementToBeClickable(next10));
			js.executeScript("arguments[0].scrollIntoView();",next10 );
